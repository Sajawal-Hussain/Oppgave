...
function showTools (){
    ...
    document.getElementById('cardTools').innerHTML = /*html*/`
     ...
     De to viktigste verktøyene vi skal bruke er disse:
        ...
        <li>Nettleseren <a href="https://googlechrome.com"> Google Chrome</a>
        </li>
        </ul>
        </div>
    `;}
...
document.getElementById('cardHKB').innerHTML = /*html*/`
...
function blankAll () {
    ...
    document.getElementById('cardHKB').innerHTML = '';
}
...
function Setnumberdown () {
    Numtoshow --;
    document.getElementById('output').innerHTML = Numtoshow; 
};
